...
public class calc extends  AppCompatActivity  implements View.OnClickListener{
    private Button numeroZero, numeroUm, numeroDois, numeroTres,
            ...
            soma, subtracao, raiz, Restodiv, igual, botao_limpar;
    private TextView txtExpressao, txtResultado,expressao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Restodiv.setOnClickListener(this);
        ...
        raiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                double conta;
                if (expressao.getText() == "") {
                    conta = Double.parseDouble(String.valueOf(expressao.getText()));
                    conta = Math.sqrt(conta);
                    expressao.setText(String.valueOf(conta));
                }
            }
        });
    ...
    private void iniciarComponentes() {
        ...
        Restodiv = findViewById(R.id.restodiv);
